		...
		return (
			<main ref={(el) => this.el = el}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/Toolbar.js"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarCdn.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ToolbarCdn/>
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarConfigured.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ToolbarConfigured/>
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarProps.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ToolbarProps/>
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarData.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ToolbarData/>
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarEvents.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ToolbarEvents/>
...
export default connect(state => state)(ToolbarPage);