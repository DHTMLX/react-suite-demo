		...
		return (
			<main ref={el => (this.el = el)}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/Toolbar.js"
							target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarCdn.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarConfigured.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarProps.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarData.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/toolbar/ToolbarEvents.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
