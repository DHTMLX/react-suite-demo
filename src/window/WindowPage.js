		...
		return (
			<main ref={el => (this.el = el)}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/window/Window.js"
							target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/window/WindowCdn.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/window/WindowConfigured.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
