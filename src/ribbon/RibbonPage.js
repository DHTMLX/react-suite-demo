		...
		return (
			<main ref={el => (this.el = el)}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/ribbon/Ribbon.js"
							target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/ribbon/RibbonCdn.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/ribbon/RibbonConfigured.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/ribbon/RibbonProps.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/ribbon/RibbonData.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/ribbon/RibbonEvents.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
