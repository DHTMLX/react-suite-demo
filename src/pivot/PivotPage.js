		...
		return (
			<main ref={(el) => this.el = el}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/pivot/Pivot.js" target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/pivot/PivotCdn.js"
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/pivot/PivotConfigured.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<PivotConfigured/>
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/pivot/PivotProps.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<PivotProps/>
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/pivot/PivotEvents.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div>
						<PivotEvents/>
