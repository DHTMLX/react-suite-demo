		...
		return (
			<main ref={el => (this.el = el)}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/menu/Menu.js"
							target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/menu/MenuCdn.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/menu/MenuConfigured.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/menu/MenuProps.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/menu/MenuData.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a
							href="https://github.com/DHTMLX/react-widgets/blob/master/src/menu/MenuEvents.js"
							target="_blank"
							rel="noopener noreferrer"
						>
							Code example{" "}
