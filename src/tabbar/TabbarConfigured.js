...
class TabbarConfigured extends Component {
	componentDidMount() {
	...
	render() {
		return <div style={{ width: 802, height: 400 }} ref={el => (this.el = el)}></div>;
	}
}

TabbarConfigured.propTypes = {
	mode: PropTypes.oneOf(["top", "bottom", "left", "right"]),
