		...
		return (
			<main ref={(el) => this.el = el}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/sidebar/Sidebar.js"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/sidebar/SidebarCdn.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<SidebarCdn/>
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/sidebar/SidebarConfigured.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<SidebarConfigured/>
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/sidebar/SidebarProps.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<SidebarProps/>
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/sidebar/SidebarData.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<SidebarData/>
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/sidebar/SidebarEvents.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<SidebarEvents/>
