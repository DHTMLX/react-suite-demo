		...
		return (
			<main ref={(el) => this.el = el}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/tree/Tree.js" target="_blank"  rel="noopener noreferrer" >Code example </a> 
					</p>
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/tree/TreeCdn.js" target="_blank"  rel="noopener noreferrer" >Code example </a> 
					</p>
					<div style={{display: 'flex', justifyContent: 'center'}}>
						<TreeCdn /> 
					</div>
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/tree/TreeConfigured.js" target="_blank"  rel="noopener noreferrer" >Code example </a> 
					</p>
					<div style={{display: 'flex', justifyContent: 'center'}}>
						<TreeConfigured />
					</div>
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/tree/TreeProps.js" target="_blank"  rel="noopener noreferrer" >Code example </a> 
					</p>
					<div style={{display: 'flex', justifyContent: 'center'}}>
						<TreeProps />
					</div>
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/tree/TreeData.js" target="_blank"  rel="noopener noreferrer" >Code example </a> 
					</p>
					<div style={{display: 'flex', justifyContent: 'center'}}>
						<TreeData />
					</div>
...
export default connect(state => state)(TreePage)