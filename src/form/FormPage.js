		...
		return (
			<main ref={(el) => this.el = el}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/form/Form.js" target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/form/FormCdn.js"
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/form/FormConfigured.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<FormConfigured/>
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/form/FormProps.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<FormProps/>
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/form/FormEvents.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<FormEvents/>
