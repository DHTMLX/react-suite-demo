		...
		return (
			<main ref={(el) => this.el = el}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/list/List.js" target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/list/ListCdn.js"
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/list/ListConfigured.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ListConfigured/>
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/list/ListProps.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ListProps/>
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/list/ListData.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ListData/>
				...
				<section className="hgroup" id="events">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/list/ListEvents.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ListEvents/>
