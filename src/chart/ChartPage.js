		...
		return (
			<main ref={(el) => this.el = el}>
				<section className="hgroup active" id="basic">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/chart/Chart.js" target="_blank"
				...
				<section className="hgroup" id="cdn">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/chart/ChartCdn.js"
				...
				<section className="hgroup" id="pre">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/chart/ChartConfigured.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ChartConfigured/>
				...
				<section className="hgroup" id="props">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/chart/ChartProps.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ChartProps/>
				...
				<section className="hgroup" id="data">
					...
					<p>
						<a href="https://github.com/DHTMLX/react-widgets/blob/master/src/chart/ChartData.js"
						   target="_blank" rel="noopener noreferrer">Code example </a>
					</p>
					<div style={{display: "flex", justifyContent: "center"}}>
						<ChartData/>
